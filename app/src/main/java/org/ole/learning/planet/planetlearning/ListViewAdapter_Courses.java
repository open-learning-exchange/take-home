...
public class ListViewAdapter_Courses extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setText(material.get(Fragm_Library.KEY_TITLE));
        description.setText(material.get(Fragm_Library.KEY_DESCRIPTION));
        details.setText("Details");
        details.setTag(material.get(Fragm_Library.KEY_DETAILS));
        ...
        feedback.setTag(material.get(Fragm_Library.KEY_FEEDBACK));
        ...
        addToMyLibrary.setTag(material.get(Fragm_Library.KEY_DELETE));
        ...
        ratingAvgNum.setText(""+material.get(Fragm_Library.KEY_RATING));
        ratingStars.setRating(Float.parseFloat(""+material.get(Fragm_Library.KEY_RATING)));
        totalNum.setText(material.get(Fragm_Library.KEY_TOTALNUM_RATING));
        ...
        imageLoader.DisplayImage(material.get(Fragm_Library.KEY_THUMB_URL), thumb_image);
        return vi;
    }
}